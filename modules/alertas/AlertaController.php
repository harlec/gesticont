...
class AlertaController {
    public function index(): void {
        Auth::require();
        $pageTitle = 'Alertas y vencimientos';
        ob_start();
        require_once ROOT . '/modules/alertas/views/index.php';
        $content = ob_get_clean();
        require_once ROOT . '/views/layout/base.php';
    }
    public function store(): void { Auth::require(); header('Location: /' . strtolower(str_replace('Controller','','AlertaController'))); exit; }
