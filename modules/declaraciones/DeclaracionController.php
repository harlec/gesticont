...
class DeclaracionController {
    public function index(): void {
        Auth::require();
        $pageTitle = 'Declaraciones PDT';
        ob_start();
        require_once ROOT . '/modules/declaraciones/views/index.php';
        $content = ob_get_clean();
        require_once ROOT . '/views/layout/base.php';
    }
    public function store(): void { Auth::require(); header('Location: /' . strtolower(str_replace('Controller','','DeclaracionController'))); exit; }
