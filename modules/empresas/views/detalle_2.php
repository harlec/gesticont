...
<div style="display:flex;align-items:center;gap:16px;margin-bottom:24px;">
    ...
    <div style="display:flex;gap:10px;">
        ...
        <a href="/empresas/<?= $empresa['id'] ?>/certificado" style="background:#fef3c7;color:#92400e;padding:8px 16px;border-radius:8px;font-size:13px;font-weight:600;text-decoration:none;">Certificado SOL</a>
    </div>
</div>
...
<div style="display:grid;grid-template-columns:repeat(3,1fr);gap:16px;margin-bottom:24px;">
    <div style="background:white;border-radius:12px;padding:18px;border:1px solid #e2e8f0;box-shadow:0 1px 4px rgba(0,0,0,0.05);">
        ...
        <div style="font-size:12px;color:#94a3b8;margin-top:4px;"><?= (int)($ultimasVentas['cant'] ?? 0) ?> comprobantes</div>
    </div>
    <div style="background:white;border-radius:12px;padding:18px;border:1px solid #e2e8f0;box-shadow:0 1px 4px rgba(0,0,0,0.05);">
        ...
        <div style="font-size:12px;color:#94a3b8;margin-top:4px;"><?= (int)($ultimasCompras['cant'] ?? 0) ?> facturas</div>
    </div>
    <div style="background:white;border-radius:12px;padding:18px;border:1px solid #e2e8f0;box-shadow:0 1px 4px rgba(0,0,0,0.05);">
        ...
        <?php if ($cert): ?>
            ...
            <div style="font-size:12px;color:#94a3b8;margin-top:4px;">Ambiente: <?= ucfirst($cert['ambiente'] ?? 'beta') ?></div>
        <?php else: ?>
