...
<body style="background:#f8fafc;color:#1e293b;min-height:100vh;display:flex;">
<?php require_once ROOT . '/views/layout/sidebar.php'; ?>
<main style="margin-left:240px;flex:1;min-height:100vh;display:flex;flex-direction:column;">
